...
4. O arquivo vai abrir direto no seu navegador (Chrome, Firefox, Edge...)
5. Pronto! A vitrine já está funcionando

Não precisa instalar nada, não precisa de internet (só as fontes do Google Fonts carregam de fora), não precisa de servidor.

## Integrantes do grupo

- Fabian De Jesus Romero Corona
- Vitor Barboza Teixeira
